...
final class TestExperiment2 extends AbstractCloudletTaskCompletionTimeExperiment {
    ...
    private TestExperiment2(final long seed) {
        this(0, null, seed);
    }

    TestExperiment2(final int index, final ExperimentRunner runner) {
        this(index, runner, -1);
    }

    private TestExperiment2(final int index, final ExperimentRunner runner, final long seed) {
    ...
    public static void main(String[] args) {
        final TestExperiment2 exp = new TestExperiment2(344L);
        exp.setVerbose(true);
        exp.run();
        System.out.println();
